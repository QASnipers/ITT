...
public class Actions {
	...
	public static WebElement getElement(UIObject obj){
		...
		if(obj.getIdentifier().equalsIgnoreCase("Byid")){
			elements = Browser.driver.findElement(By.id(obj.getId()));
		}
		
		else if(obj.getIdentifier().equalsIgnoreCase("Byname")){
			elements = Browser.driver.findElement(By.name(obj.getName()));
		}
		
		else if(obj.getIdentifier().equalsIgnoreCase("Byxpath")){
			elements = Browser.driver.findElement(By.xpath(obj.getXpath()));
		}
		
		else if(obj.getIdentifier().equalsIgnoreCase("BycssSelector")){
			elements = Browser.driver.findElement(By.cssSelector(obj.getCssselector()));
		}
		
		else if(obj.getIdentifier().equalsIgnoreCase("Bypartiallinktext")){
			elements = Browser.driver.findElement(By.partialLinkText(obj.getText()));
		}
		
		else if(obj.getIdentifier().equalsIgnoreCase("Bylinktext")){
			elements = Browser.driver.findElement(By.linkText(obj.getText()));
		}
			...
			if(obj.getType().equalsIgnoreCase("radio") || obj.getType().equalsIgnoreCase("checkbox")){
				...
				if(obj.getType().equalsIgnoreCase("radio")){
					elements = Browser.driver.findElement(By.xpath("//input[@type='radio']"));
				}else if(obj.getType().equalsIgnoreCase("checkbox")){ //Checkboxes retrieval
					elements = Browser.driver.findElement(By.xpath("//input[@type='checkbox']"));
				}
			}
			...
			elements = Browser.driver.findElement(By.className(obj.getClassname()));
		}
		return elements;
	}
